...
10.times do
  ...
  shibuya_store.orders.create!(
    ...
    order_count: rand(100..500),
    inspected: rand(0..1),
    inspection_count: rand(100..500),
...
print "Creating 100 order items of 5 orders above... "
Product.all.each do |product|
  order = Order.find(rand(1..10))
  OrderItem.create!(
    order: order,
...
print "Creating 100 inspections belongs to 100 order items above... "
