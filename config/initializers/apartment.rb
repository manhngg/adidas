...
Apartment.configure do |config|
  ...
  config.excluded_models = %w{ Company }
	...
	# Run db:seed after create tenant
	# config.seed_after_create = true unless Rails.env.production?
...
# www or subdomain "admin" will access common database
#Rails.application.config.middleware.use Apartment::Elevators::Generic, lambda { |request|
#	request.host.split('.').first unless request.host.split(".").first.in? ["www", "admin"]
#}
