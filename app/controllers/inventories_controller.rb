class InventoriesController < BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @inventory.save
        format.html { redirect_to inventories_url(store_id: @store.id), notice: t("flash.create", name: "棚卸") }
      else
  ...
  def toggle_done
    ...
    redirect_to inventories_url(store_id: @store.id), notice: t("flash.update", name: "ステータス")
  end
